    ...
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"E:\22.11.4806\Pertemuan 8\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
        ...
        private void btnCariDelete_Click(object sender, EventArgs e)
        {
            ...
            // membuat objek DataReader untuk menampung hasil perintah
            SQLiteDataReader dtr = cmd.ExecuteReader(); // eksekusi perintah 
            if (dtr.Read()) // data ditemukan
            {
                // tampilkan nilainya ke textbox
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dr = MessageBox.Show("Apakah anda yakin ingin menghapus data mahasiswa?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
